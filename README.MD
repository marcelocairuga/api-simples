...
- Estudante (nome, email, curso e semestre no curso);
- Um estudante deve estar matriculado em um curso.
...
- O estudante é identificado por uma matrícula (id) que deve ser gerada automaticamente pelo sistema;
